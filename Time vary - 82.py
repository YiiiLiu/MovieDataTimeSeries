...
desktop_directory = os.path.expanduser('/Users/sammi/Desktop/Time_Vary - 82')
...
columns_to_extract = [
    ...
    'DEMO_US_RATING10', 'RATING01', 'RATING02', 'RATING03', 'RATING04', 'RATING05',
    'RATING06', 'RATING07', 'RATING08', 'RATING09', 'RATING10', 'M_RATING_A18',
    'M_RATING_A30', 'M_RATING_A45', 'M_RATING_U18', 'M_RATING_F', 'M_RATING_F_A18',
    'M_RATING_F_A30', 'M_RATING_F_A45', 'M_RATING_F_U18', 'M_RATING_STAFF', 'M_RATING_M',
    'M_RATING_M_A18', 'M_RATING_M_A30', 'M_RATING_M_A45', 'M_RATING_M_U18', 'M_RATING_NUS',
    'M_TOPUSER', 'M_RATING_US', 'N_A18', 'N_A30', 'N_A45', 'N_U18', 'N_F', 'N_F_A18',
    'N_F_A30', 'N_F_A45', 'N_F_U18', 'N_RATING_STAFF', 'N_M', 'N_M_A18', 'N_M_A30',
    'N_M_A45', 'N_M_U18', 'N_NUS', 'N_TOPUSER', 'N_US'
]
